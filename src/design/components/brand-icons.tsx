 ...
 *    memberi ukuran.
 * 3. `focusable="false"` mencegah svg ikut tab-order (perilaku khas Edge).
 * 4. Class dasar `block shrink-0` agar flex tidak menyusutkan ikon ke 0.
 */
const BrandSvg: React.FC<{
 ...
 <svg
    ...
    fill="currentColor"
    focusable="false"
    className={["block shrink-0 h-4 w-4", className].filter(Boolean).join(" ")}
    aria-hidden="true"
    role="img"
  >
    {children}
...
export const LinkedInBrandIcon: React.FC<BrandIconProps> = ({ className }) => (
...
export const GithubBrandIcon: React.FC<BrandIconProps> = ({ className }) => (
 <BrandSvg className={className}>
...
export const GmailBrandIcon: React.FC<BrandIconProps> = ({ className }) => (
 <BrandSvg className={className}>
    <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z" />
 </BrandSvg>
);

export const WhatsAppBrandIcon: React.FC<BrandIconProps> = ({ className }) => (
 <BrandSvg className={className}>
